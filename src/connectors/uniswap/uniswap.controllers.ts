...
export async function addLiquidity(
  ...
  console.log('req.amount0', req.amount0)
  console.log('req.amount1', req.amount1)
  console.log('req.fee.toUpperCase()', req.fee.toUpperCase())
  console.log('Number(req.lowerPrice)', Number(req.lowerPrice))
  console.log('Number(req.upperPrice)', Number(req.upperPrice))
  console.log('req.tokenId ? req.tokenId : 0', req.tokenId ? req.tokenId : 0)
  console.log('gasLimitTransaction', gasLimitTransaction)
  console.log('gasPrice', gasPrice)
  console.log('req.nonce', req.nonce)
  console.log('maxFeePerGasBigNumber', maxFeePerGasBigNumber)
  console.log('maxPriorityFeePerGasBigNumber', maxPriorityFeePerGasBigNumber)
